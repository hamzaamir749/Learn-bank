    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View v) {
                if (currentQuizQuestion <= list.size() - 1) {
                    ...
                    if (correctAnswers >= wronganswer) {
                        if (sharedHelper.getKey("quiztype").equals("weekly")) {
                            saveWeekly();
                        } else {
                            saveMonthly();
                        }
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (ans.equals("")) {
                    Toast.makeText(context, "Select One Please", Toast.LENGTH_SHORT).show();
                    return;
                }
...
//                        Toast.makeText(GameQuizActivity.this, "You got the answer correct", Toast.LENGTH_LONG).show();
                        ...
                        pDialog
                                ...
                                .addButton(
                                        ...
                                        new PrettyDialogCallback() {
                                            ...
                                            public void onClick() {
                                                pDialog.dismiss();
                                                startActivity(new Intent(context, QuizHomeActivity.class));
                                                finish();
                                            }
                                        }
                                )
    ...
    private void getData() {
        dialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLHelper.QUIZ_QUESTIONS, new Response.Listener<String>() {
            @Override
            ...
            protected Map<String, String> getParams() throws AuthFailureError {
                ...
                map.put("quiz_id", sharedHelper.getKey("quizid"));
                return map;
            }
        };
    ...
    private void saveWeekly() {
        dialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLHelper.QUIZ_PROGRESS_WEEKLY, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                dialog.dismiss();
                Log.d("loginres", response);
    ...
    private void saveMonthly() {
        dialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLHelper.QUIZ_PROGRESS_MONTHLY, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                dialog.dismiss();
                Log.d("loginres", response);
