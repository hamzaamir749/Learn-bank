...
import com.coderpakistan.learningbank.Models.QuizHomeModel;
...
import com.coderpakistan.learningbank.databinding.ActivityWeeklyQuizBinding;
...
public class WeeklyQuizActivity extends AppCompatActivity {
    ...
    Context context = WeeklyQuizActivity.this;
    ...
    private void getData() {
        list = new ArrayList<>();
        dialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLHelper.QUIZ_WEEKLY, new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if (status) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            list.add(new SessionVocabularyModel(object.getString("id"), object.getString("name"), "weekly", object.getBoolean("unlocked")));
                        }
                        binding.quizweeklyRecycler.setAdapter(new QuizHomeAdapter(list, context));
                    } else {
    ...
    private void initViews() {
        ...
        binding.quizweeklyRecycler.setLayoutManager(new LinearLayoutManager(context));
    }
}
