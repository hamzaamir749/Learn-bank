...
public class DirectLevelVocabularyActivity extends AppCompatActivity {
    ActivityDirectLevelVocabularyBinding binding;
    Context context = DirectLevelVocabularyActivity.this;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityDirectLevelVocabularyBinding.inflate(getLayoutInflater());
        setContentView(binding.getRoot());
        initViews();
        id = sharedHelper.getKey("directsessionid");
        binding.toolName.setText(sharedHelper.getKey("directsessionname"));
    ...
    private void getData() {
        list = new ArrayList<>();
        dialog.show();
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URLHelper.DIRECT_LEVELS, new Response.Listener<String>() {
            @Override
                ...
                try {
                    ...
                    if (status) {
                        ...
                        for (int i = 0; i < jsonArray.length(); i++) {
                            ...
                            list.add(new SessionVocabularyModel(object.getString("id"), object.getString("name"),"levelvocabulary",object.getBoolean("unlocked")));
                        }
    ...
    private void initViews() {
        ...
        dialog = new LoadingDialog(DirectLevelVocabularyActivity.this);
